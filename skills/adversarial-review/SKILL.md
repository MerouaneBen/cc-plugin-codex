...
- After `spawn_agent` accepts the child, tell the user: `Claude Code adversarial review forwarding is queued as <job-id>; launch is not yet verified. Check $cc:status <job-id>.`
- Do not fix anything mentioned in the review output.
